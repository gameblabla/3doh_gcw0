#ifndef LIBFREEDO_SWI_HLE_0X5XXXX_H_INCLUDED
                       ...
                       uint32_t  r2_)
{
  ...
  dest = (vec3f16*)&ram_[r0_];
  vec  = (vec3f16*)&ram_[r1_];
  mat  = (mat33f16*)&ram_[r2_];
                       ...
                       uint32_t  r2_)
{
  ...
  dest = (mat33f16*)&ram_[r0_];
  src1 = (mat33f16*)&ram_[r1_];
  src2 = (mat33f16*)&ram_[r2_];
                       ...
                       uint32_t  r3_)
{
  ...
  dest  = (frac16*)&ram_[r0_];
  src1  = (frac16*)&ram_[r1_];
  src2  = (frac16*)&ram_[r2_];
  count = (int32_t)r3_;
                       ...
                       uint32_t  r2_)
{
  ...
  dest = (vec4f16*)&ram_[r0_];
  vec  = (vec4f16*)&ram_[r1_];
  mat  = (mat44f16*)&ram_[r2_];
                       ...
                       uint32_t  r2_)
{
  ...
  dest = (mat44f16*)&ram_[r0_];
  src1 = (mat44f16*)&ram_[r1_];
  src2 = (mat44f16*)&ram_[r2_];
                       ...
                       uint32_t  r0_)
{
  ...
  dest  = (vec3f16*)&ram_[*(uint32_t*)&ram_[r0_ + 0x00]];
  src   = (vec3f16*)&ram_[*(uint32_t*)&ram_[r0_ + 0x04]];
  mat   = (mat33f16*)&ram_[*(uint32_t*)&ram_[r0_ + 0x08]];
  n     = *(frac16*)&ram_[r0_ + 0x0C];
  count = *(uint32_t*)&ram_[r0_ + 0x10];
